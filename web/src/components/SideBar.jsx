    ...
    <div className="w-96 h-screen flex flex-col border-r-2 border-darkGreen">
      ...
      <nav className="w-full h-4/6 flex flex-col justify-center pl-24">
        <div className="flex flex-col">
          ...
          <a href="#" className="text-darkGreen font-bold w-2/3 mt-4 py-1 pl-4 rounded-lg hover:bg-lightRed hover:text-primaryWhite">Shopping list</a>
          <a href="#" className="text-darkGreen font-bold w-2/3 mt-4 py-1 pl-4 rounded-lg hover:bg-lightRed hover:text-primaryWhite">Cleaning tasks</a>
        ...
        <div className="flex flex-col">
          ...
          <a href="#" className="text-darkGreen font-bold w-2/3 mt-4 py-1 pl-4 rounded-lg hover:bg-lightRed hover:text-primaryWhite">Profile</a>
          <a href="#" className="text-darkGreen font-bold w-2/3 mt-4 py-1 pl-4 rounded-lg hover:bg-lightRed hover:text-primaryWhite">Log out</a>
        </div>
      </nav>
      ...
      <div className="w-full h-[30%]">
        <img
          ...
          alt="Home picture"
          className="object-cover h-full w-full object-bot"
        />
      </div>
    </div>
  );
