...
function Weather() {
  ...
  if (loading) {
    return <div role="status" className="flex justify-center items-center">
      <svg aria-hidden="true" className="inline w-8 h-8 mr-2 text-gray-200 animate-spin fill-lightRed" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
